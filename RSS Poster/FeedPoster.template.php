...
function template_main()
{
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg">
			<td>
				<form action="',$scripturl,'?action=admin;area=feedsadmin;sa=bulkactions" method="post">
				<table class="table_grid">
				    <thead>
					<tr class="table_head">
						<th></th>
						<th>', $txt['feedposter_feedtitle'], '</th>
						<th>', $txt['feedposter_feedurl'], '</th>
						<th>', $txt['feedposter_postername'], '</th>
						<th>', $txt['feedposter_total_posts'], '</th>
						<th>', $txt['feedposter_feedstatus'], '</th>
						<th>', $txt['feedposter_nextupdatetime']. '</th>
						<th>', $txt['feedposter_options'], '</th>
					</tr>
					</thead>';
					...
					foreach ($context['feeds'] as $key => $feed)
					{
						echo '<tr class="' . $styleClass . '">
								...
								<td>', (empty($feed['updatetime']) ? '' : standardTime($feed['updatetime'])), '</td>
	...
	<tr class="windowbg">
				...
				<form method="post" action="', $scripturl, '?action=admin;area=feedsadmin;sa=saveset">
	...
	echo '<br /><div align="center"><a href="http://www.elkartemods.com" target="blank">RSS Feed Poster</a></div>';
...
echo '
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg">
			<td>
			<form method="post" action="', $scripturl, '?action=admin;area=feedsadmin;sa=addfeed2" name="frmfeed">
...
echo '
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg">
			<td>
			<form method="post" action="', $scripturl, '?action=admin;area=feedsadmin;sa=editfeed2" name="frmfeed">
				<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4">
