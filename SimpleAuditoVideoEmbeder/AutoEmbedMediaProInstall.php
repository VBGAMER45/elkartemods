...
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_default_width', '0')");
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_default_height','0')"); 
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_copyrightkey','')"); 
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_disablesig','0')"); 
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_disablemobile','0')"); 
$db->query('', "REPLACE INTO {db_prefix}settings VALUES ('autoLinkUrls','1')"); 

$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_showlink','0')");
$db->query('', "INSERT IGNORE INTO {db_prefix}settings VALUES ('mediapro_max_embeds','0')");



$db->query('', "CREATE TABLE IF NOT EXISTS {db_prefix}mediapro_cache (
...
$db->query('', "CREATE TABLE IF NOT EXISTS {db_prefix}mediapro_sites (
  id int(11) NOT NULL auto_increment,
  title varchar(255),
...
$db->query('', "REPLACE INTO {db_prefix}mediapro_sites
...
' . "')");
  ...
  // Make sure still enabled
    if (!empty($enabledList))
    {
        ...
        $db->query('', "UPDATE {db_prefix}mediapro_sites SET enabled = 1
