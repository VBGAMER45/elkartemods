...
function template_mainview()
{
	...
	if (!empty($cat))
	{
        ...
        $button_strip = array();
			 $button_strip['buttons']['addsubcat'] =  array(
            'text' => 'downloads_text_addsubcat',
            'url' => $scripturl . '?action=downloads;sa=addcat;cat=' . $cat,
            'lang' => true,
            'image' => '',
		...
		foreach ($context['downloads_files'] as $i => $file)
		{
			...
			if (!empty($modSettings['down_set_t_date']))
				echo '<td>', standardTime($file['date']), '</td>';
		...
		if (!empty($modSettings['down_who_viewing']))
		{
			...
			echo '</table>';
			 ...
			 echo '<table><tr><td>' . $txt['downloads_text_pages']  . '</td>
	...
	echo '<div class="roundframe centertext"><a href="' . $scripturl . '?action=downloads">' . $txt['downloads_text_returndownload'] . '</a></div><br />';
...
<tr class="table_head">
		...
		foreach ($context['downloads_cats'] as $i => $cat_info)
		{
			...
			echo '<td class="windowbg">', $totalfiles, '</td>';
	...
	if (empty($modSettings['down_index_showtop']))
	{
        ...
        ', $txt['downloads_text_adminpanel'], '
            ...
            <table class="table_grid">
 				<tr class="windowbg2">
			<td align="center"><a href="' . $scripturl . '?action=downloads;sa=addcat">' . $txt['downloads_text_addcategory'] . '</a>&nbsp;<a href="' . $scripturl . '?action=admin;area=downloads;sa=adminset">' . $txt['downloads_text_settings'] . '</a>&nbsp;';
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' . $txt['downloads_form_title'] .'</b></td>
    <td width="72%"  class="windowbg2"><input type="text" name="title" size="64" maxlength="100" /></td>
  </tr>
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' . $txt['downloads_text_parentcategory'] .'</b>&nbsp;</td>
  ...
  <tr>
    <td width="28%"  valign="top" class="windowbg2" align="right"><b>' . $txt['downloads_form_description'] . '</b>&nbsp;<br />'. $txt['downloads_text_bbcsupport'] .'</td>
...
echo '</td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' . $txt['downloads_form_icon'] . '</b></td>
    <td width="72%"  class="windowbg2"><input type="text" name="image" size="64" maxlength="100" /></td>
  </tr>
   <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' . $txt['downloads_form_uploadicon'] . '</b></td>
...
echo '
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' .   $txt['downloads_text_cat_disableratings'] . '</b></td>
    <td width="72%"  class="windowbg2"><input type="checkbox" name="disablerating" /></td>
  </tr>
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' .   $txt['downloads_txt_sortby']  . '</b></td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' .   $txt['downloads_txt_orderby'] . '</b></td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' . $txt['downloads_text_boardname'] . '</b></td>
    <td width="72%"  class="windowbg2">
...
echo '
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' .   $txt['downloads_form_filenameicon'] . '</b></td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><b>' .   $txt['downloads_txt_sortby']  . '</b>&nbsp</td>
    <td width="72%"  class="windowbg2"><select name="sortby">
    	',$sortselect,'
		<option value="date">',$txt['downloads_txt_sort_date'],'</option>
		<option value="title">',$txt['downloads_txt_sort_title'],'</option>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"></td><b>' .   $txt['downloads_txt_orderby'] . '</b></td>
    <td width="72%"  class="windowbg2"><select name="orderby">
    	',$orderselect,'
		<option value="desc">',$txt['downloads_txt_sort_desc'],'</option>
		<option value="asc">',$txt['downloads_txt_sort_asc'],'</option>
...
<div class="cat_bar">
		<h3 class="category_header centertext">
        ', $txt['downloads_text_delcategory'], '
        </h3>
</div>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
echo '
 ...
 echo '
  ...
  if ($g_manage == true)
  {
	  ...
	  <a href="', $scripturl, '?action=findmember;input=pic_postername;quote=1;sesc=', $context['session_id'], '" onclick="return reqWin(this.href, 350, 400);"><img src="', $settings['images_url'], '/icons/assist.png" alt="', $txt['find_members'], '" /></a>
...
<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">';
		...
		echo '
			...
			if ($modSettings['down_set_file_lastdownload'])
				echo $txt['downloads_text_lastdownload'] . ' ' . ($context['downloads_file']['lastdownload'] != 0 ? standardTime($context['downloads_file']['lastdownload']) : $txt['downloads_text_lastdownload2'] ) . '&nbsp;';
		...
		if ($modSettings['down_set_file_prevnext'])
			...
			if ($modSettings['down_set_file_showrating'])
				...
				if ($g_manage)
                    ...
                    'text' => 'downloads_text_unapprove2',
                    'url' => $scripturl . '?action=downloads;sa=unapprove&id=' . $context['downloads_file']['ID_FILE'],
                    'lang' => true,
                    'image' => '',
                        );
				...
				if ($g_manage || $g_edit_own && $context['downloads_file']['id_member'] == $user_info['id'])
                    ...
                    'text' => 'downloads_text_edit2',
                    'url' => $scripturl . '?action=downloads;sa=edit&id=' . $context['downloads_file']['ID_FILE'],
                    'lang' => true,
                    'image' => '',
                        );
				...
				if ($g_manage || $g_delete_own && $context['downloads_file']['id_member'] == $user_info['id'])
                    ...
                    'text' => 'downloads_text_delete2',
                    'url' => $scripturl . '?action=downloads;sa=delete&id=' . $context['downloads_file']['ID_FILE'],
                    'lang' => true,
                    'image' => '',
                        );
				...
				if ($g_report)
				{
                    ...
                    'text' => 'downloads_text_reportdownload2',
                    'url' => $scripturl . '?action=downloads;sa=report&id=' . $context['downloads_file']['ID_FILE'],
                    'lang' => true,
                    'image' => '',
                        );
				...
				if (!empty($button_strip))
				    template_button_strip($button_strip['buttons']);
...
<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">
		...
		if (allowedTo('downloads_comment'))
		{
            ...
            'text' => 'downloads_text_addcomment',
            'url' => $scripturl . '?action=downloads;sa=comment&id=' . $context['downloads_file']['ID_FILE'],
            'lang' => true,
            'image' => '',
		...
		foreach ($context['downloads_comments'] as $i => $comment)
		{
			...
			// Display the comment
			echo '<td width="90%"><span class="smalltext">' . standardTime($comment['date']) . '</span><hr />';
			...
			if ($comment['modified_id_member'] != 0)
			{
				...
				echo '<br /><span class="smalltext"><i>' . $txt['downloads_text_commodifiedby']  . '<a href="' . $scripturl . '?action=profile;u=' . $comment['modified_id_member'] . '">'  . $comment['modmember'] . '</a> ' . standardTime($comment['lastmodified']) .  ' </i></span>';
            ...
            if ($g_manage || $g_report ||  ($g_edit_comment && $comment['id_member'] == $user_info['id']))
                echo '<br />';

            // Check if they can edit the comment
			if ($g_manage || $g_edit_comment && $comment['id_member'] == $user_info['id'])
				echo '&nbsp;<a href="' . $scripturl . '?action=downloads;sa=editcomment&id=' . $comment['ID_COMMENT'] . '">' . $txt['downloads_text_edcomment'] .'</a>';

			if ($g_manage || $g_report)
				echo '&nbsp;<a href="' . $scripturl . '?action=downloads;sa=reportcomment&id=' . $comment['ID_COMMENT'] . '">' . $txt['downloads_text_repcomment'] .'</a>';


			// Check if the user is allowed to delete the comment.
			if ($g_manage)
				echo '&nbsp;<a href="' . $scripturl . '?action=downloads;sa=delcomment&id=' . $comment['ID_COMMENT'] . '">' . $txt['downloads_text_delcomment'] .'</a>';
	...
	if ($context['show_spellchecking'])
        ...
        ' . $txt['downloads_text_addcomment'] . '
				...
				<tr>
				    <td width="28%"  valign="top" class="windowbg2" align="right"><b>' . $txt['downloads_form_comment'] . '</b>&nbsp;</td>
    ...
    echo '<div class="roundframe centertext"><a href="' . $scripturl . '?action=downloads;cat=' . $context['downloads_file']['ID_CAT'] . '">' . $txt['downloads_text_returndownload'] . '</a></div><br />';
...
echo '
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg">
			...
			<form method="post" action="' . $scripturl . '?action=admin;area=downloads;sa=adminset2">
...
echo '
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			<td>
			<form method="post" action="', $scripturl, '?action=admin;area=downloads;sa=bulkactions">
			<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">
				<thead>
			<tr class="table_head">
				<td>&nbsp;</th>
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			foreach ($context['downloads_reports'] as $i => $report)
			{
				...
				echo '<td>', standardTime($report['date']), '</td>';
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
		  	...
		  	foreach ($context['downloads_comments'] as $i => $comment)
			{
				...
				echo '<td>' . standardTime($comment['date']) . '</td>';
				if ($comment['real_name'] != '')
...
function template_search_results()
{
	...
	echo '<div class="roundframe centertext">';
				...
				echo '<a href="' . $scripturl . '?action=downloads">' . $txt['downloads_text_returndownload'] . '</a></div><br />';
...
function template_myfiles()
{
	...
	echo '</table>';
		...
		// Show return to downloads link and Show add downloads if they can
				...
				echo '
				<div class="roundframe centertext"<a href="', $scripturl, '?action=downloads">', $txt['downloads_text_returndownload'], '</div>';
...
function template_view_rating()
{
	...
	echo '
        <div class="cat_bar">
		<h3 class="category_header centertext">
        ', $txt['downloads_form_viewratings'], '
        </h3>
...
function template_filespace()
{
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
        ...
        <div class="cat_bar">
		<h3 class="category_header centertext">
        ', $txt['downloads_filespace_groupquota_title'], '
        </h3>
</div>
			<table class="table_grid">
			<tr class="table_head">
	...
	foreach ($context['downloads_members'] as $i => $member)
	{
		...
		echo '<td><a href="' . $scripturl . '?action=admin;area=downloads;sa=filelist&id=' . $member['id_member'] . '">'  . $txt['downloads_filespace_list'] . '</a></td>';
	 ...
	 echo '<table><tr><td>' . $txt['downloads_text_pages']  . '</td>
        <td><div class="pagesection">' . $context['page_index'] .
			...
			<tr class="titlebg">
					<td align="left" colspan="3">
					<form method="post" action="' . $scripturl . '?action=admin;area=downloads;sa=recountquota">
...
<tr class="table_head">
		...
		// Show the member groups
			foreach ($context['downloads_membergroups'] as $i => $row)
			{
				...
				echo '<td><a href="' . $scripturl . '?action=admin;area=downloads;sa=catpermdelete&id=' . $row['ID'] . '">' . $txt['downloads_text_delete'] . '</a></td>';
				echo '</tr>';
...
function downloads_copyright()
{
	...
	//http://www.elkartemods.com/downloads-linkremoval.php

	//Copyright link must remain. To remove you need to purchase link removal at elkartemods.com
	echo '<div align="center"><!--Link must remain or contact me to pay to remove.--><span class="smalltext">Powered by: <a href="http://www.elkartemods.com" target="_blank">Download System</a> by <a href="http://www.createaforum.com" title="Forum Hosting">CreateAForum.com</a></span><!--End Copyright link--></div>';
