...
$txt['gallery_text_reportpicture2'] = 'Report Picture';
$txt['gallery_text_delcomment2'] = 'Delete Comment';
...
$txt['gallery_txt_copyremovalnote'] = 'Copyright removal removes the text at the bottom of the gallery pages titled "Powered by ezGallery" and removes any link back to elkartemods.com';
...
//Begin ezGallery Text Strings
$txt['ezgallery_title'] = 'Gallery For Elkarte';
$txt['ezgallery_menu'] = 'Gallery';
$txt['ezgallery_version'] = '5.0 Lite';
$txt['ezgallery_admin'] = 'Gallery Configuration';
$txt['gallery_txt_convertors'] = 'Convertors';

//Permissions
$txt['permissiongroup_ezgallery'] = 'ezGallery';
$txt['permissiongroup_simple_ezgallery'] = 'Use ezGallery.';

$txt['permissionname_ezgallery_view'] = 'View ezGallery';
$txt['permissionhelp_ezgallery_view'] = 'Allows the user to view the Gallery';
$txt['cannot_ezgallery_view'] = 'You are not allowed to view the Gallery';

$txt['permissionname_ezgallery_add'] = 'Add Picture';
$txt['permissionhelp_ezgallery_add'] = 'Allows the user to add a picture.';
$txt['cannot_ezgallery_add'] = 'You are not allowed to add a picture.';

$txt['permissionname_ezgallery_edit'] = 'Edit own Picture';
$txt['permissionhelp_ezgallery_edit'] = 'Allows the user to edit a picture.';
$txt['cannot_ezgallery_edit'] = 'You are not allowed to edit a picture.';

$txt['permissionname_ezgallery_delete'] = 'Delete own Picture';
$txt['permissionhelp_ezgallery_delete'] = 'Allows the user to delete a picture.';
$txt['cannot_ezgallery_delete'] = 'You are not allowed to delete a picture.';

$txt['permissionname_ezgallery_comment'] = 'Leave Comments';
$txt['permissionhelp_ezgallery_comment'] = 'Allows the user to leave comments on a picture.';
$txt['cannot_ezgallery_comment'] = 'You are not allowed to leave comments.';

$txt['permissionname_ezgallery_report'] = 'Report Pictures/Comments';
$txt['permissionhelp_ezgallery_report'] = 'Allows the user to report pictures and comments.';
$txt['cannot_ezgallery_report'] = 'You are not allowed to report content.';

$txt['permissionname_ezgallery_autoapprove'] = 'Auto Approve Pictures';
$txt['permissionhelp_ezgallery_autoapprove'] = 'Pictures do not need to wait for approval.';

$txt['permissionname_ezgallery_manage'] = 'Manage Gallery';
$txt['permissionhelp_ezgallery_manage'] = 'Allows the user to add/delete/edit all catagories. Delete Comments, Delete Pictures, Approve Pictures';
$txt['cannot_ezgallery_manage'] = 'You are not allowed to manage gallery.';
